...
/mnt/c/Program\ Files\ \(x86\)/Microsoft\ Visual\ Studio/2022/BuildTools/MSBuild/Current/Bin/MSBuild.exe /m DarkScript3.sln /t:Build /p:Configuration=Release && rm -rv release/; mkdir -p release/lib/; cp -v DarkScript3/bin/Release/*.dll DarkScript3/bin/Release/*.xml release/lib; cp -rv DarkScript3/bin/Release/DarkScript3.exe* DarkScript3/bin/Release/Resources/ release/
